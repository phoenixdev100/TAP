...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-blue-50 relative overflow-hidden">
      ...
      <main className="container mx-auto px-6 py-10 md:px-10 md:py-16 relative z-10">
        <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center">
          ...
          >
            <div className="space-y-4">
              ...
              <motion.p 
                ...
                className="text-lg text-muted-foreground md:pr-10"
              >
            ...
            >
              {features.map((feature, i) => (
                <motion.div 
                  ...
                  className={`p-4 rounded-lg bg-gradient-to-br ${feature.color} shadow-sm border border-white/20 backdrop-blur-sm hover:shadow-md transition-all duration-300`}
                >
          ...
          >
            <Card className="w-full max-w-md mx-auto shadow-xl bg-background/95 backdrop-blur-sm border-white/20 relative overflow-hidden">
